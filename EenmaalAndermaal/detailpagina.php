    ...
    <main>
        <div class="container">
            <div class="d-flex flex-wrap">
                <div class="container-detail p-2">
                    <h2>[Titel]</h2>
                    <div class="carousel">
                ...
                <div class="container-detailbieden p-2 d-flex flex-column">
                    <div class="p-2">
                        <h4>00:00</h4>
                        <button type="button" id="meerbiedingenknop" class="btn btn-primary btn-block">Log in en bied
                            mee!
                        </button>
                    </div>
